...
<head>
    ...
    <style>
        ...
        .fallback-text { display: none; color: #84a1c0; font-size: 0.9rem; text-align: center; padding: 10px; }
...
<body>
            ...
            <div id="result-card">
                ...
                <div style="display:flex; gap:25px; align-items:center; margin-bottom:30px;">
                    <div class="photo-frame">
                        ...
                        <div id="img-fallback" class="fallback-text">IMAGE NON TROUVÉE</div>
                    </div>
                    <div class="info-text">
    ...
    <script>
        ...
        const QS = [
            ...
            { q: "Comportement ?", opt: [["Calme absolu", "Agent"], ["Stress / Sueur", "Trafiquant"], ["Hautain / Froid", "Evasion"], ["Hésitant", "Exile"]] },
            { q: "Document ?", opt: [["Passeport Bio", "Touriste"], ["Passeport Diplomatique", "Agent"], ["Documents égarés", "Exile"], ["Faux passeport", "Trafiquant"]] },
            ...
            { q: "Destination ?", opt: [["Hôtel", "Touriste"], ["Ambassade", "Agent"], ["Banque privée", "Evasion"], ["Laboratoire", "Chercheur"]] },
            { q: "Durée du séjour ?", opt: [["10 jours", "Touriste"], ["Indéfinie", "Exile"], ["48h (Transit)", "Agent"], ["24h (Transit)", "Ananas"]] },
        ...
        function finish() {
            ...
            // Calcul du gagnant avec petit bonus aléatoire pour casser les égalités de 0
            ...
            img.onerror = function() { 
                this.src = PATH + r.f; // Fallback défini dans l'objet
